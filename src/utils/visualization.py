...
def render_animation(skeleton, poses_generator, algos, t_hist, fix_0=True, azim=0.0, output=None, size=6, ncol=5, bitrate=3000, interval=200):
    """
    TODO
    ...
    def show_animation():
        ...
        anim = FuncAnimation(fig, update_video, frames=np.arange(0, poses[0].shape[0]), interval=interval, repeat=True)
        plt.draw()
