...
#skeleton = Skeleton(parents=[-1,  0,  1,  2,  0,  4,  5,  0,
...
#    while True:
#        # Get the 28 joints in pairs of 3
#        sample = data['annot3'][0][0][600:725].reshape(1, 125, 28, 3)
...
#render_animation(skeleton, pose_gen, 'train', 25, fix_0=True, output=None, size=8, ncol=2, interval=50)
